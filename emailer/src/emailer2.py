...
if __name__ == "__main__":
    ...
    client.construct_email("callumtaylor955@gmail.com", "test4 html", "<h1>test!</h1>")
    client.construct_email("callumtaylor955@gmail.com", "test5 html", "<h2>test!</h2>")
    client.send_emails()